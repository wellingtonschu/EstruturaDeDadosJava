...
public class Main {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("Exercicio 01: " + exercicio01.R(valor));

        Ex02 exercicio02 = new Ex02();
        System.out.println("Exercicio 02: " + exercicio02.fib(valor));

        Ex03 exercicio03 = new Ex03();
        System.out.println("Exercicio 03: " + exercicio03.sum(valor));

        Ex04 exercicio04 = new Ex04();
        System.out.println("Exercicio 04: " + exercicio04.sum(valor));
        ...
        System.out.println(exercicio07.Hanoi(3, 1, 2, 3));
